...
public class CabinetMock extends Thread {
    ...
    public static void serverStart() throws Exception {
        ...
        try {
            CabinetMock.log("Server bekleniyor");
...
class RequestHandler1 extends Thread {
    ...
    public static float actualTemp = 0;
...
//			messages.add("SETTARGET|70.5|180|3|5"); //Target Temperature | TimeFrame[secs] | ToleranceRate[%]
                ...
                this.tempChangeSpeed = (this.targetTemp - this.actTemp) / (this.targetTime * 100); //burda sondan bi 0 sildim
                break;
            }
            case STRTPING: {
